...
EXPORT_TREE_PATH = Path('./figures/crowdsignals_ch7_classification/own_data')
...
selected_features = ['acc_phone_Y (m/s^2)_freq_0.0_Hz_ws_40', 'gyr_phone_X (rad/s)_temp_std_ws_120',
                     'mag_phone_Z (µT)_max_freq', 'gyr_phone_Y (rad/s)_freq_1.0_Hz_ws_40',
                     'acc_phone_X (m/s^2)_freq_1.9_Hz_ws_40']
