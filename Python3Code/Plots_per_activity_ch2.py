...
for milliseconds_per_instance in GRANULARITIES:
    ...
    dataset['acc_phone_x'] = dataset['acc_phone_x'].astype(int)
    dataset['acc_phone_y'] = dataset['acc_phone_y'].astype(int)
    dataset['acc_phone_z'] = dataset['acc_phone_z'].astype(int)

    print("dataset walking and index", (dataset[dataset['labelWalking']== 1]).head(300))
    # dataset[dataset['labelWalking']== 1]
    # dataset[dataset['labelRunning']== 1]
    # print(dataset)
    # # Boxplot
    dataset1 = (dataset[dataset['labelWalking']== 1]).copy()
    dataset1 = dataset1[(dataset1.index >= '2016-02-08 19:00:25.656222395') & (dataset1.index <= '2016-02-08 19:04:37.656222395')]
    # dataset1 = dataset1[dataset1.index <= '19:04:37.656222395']
    print("dataset1 ", dataset1)
    # # DataViz.plot_dataset_boxplot(dataset, ['acc_phone_x','acc_phone_y','acc_phone_z','acc_watch_x','acc_watch_y','acc_watch_z'])
    DataViz.plot_dataset_boxplot(dataset[dataset['labelWalking']== 1], ['acc_phone_x','acc_phone_y','acc_phone_z'])
    DataViz.plot_dataset_boxplot(dataset[dataset['labelRunning']== 1], ['acc_phone_x','acc_phone_y','acc_phone_z'])

    # Plot all data
    DataViz.plot_dataset(dataset1, ['acc_'],
                                  ['like', 'like', 'like', 'like', 'like', 'like', 'like','like'],
                                  ['line', 'line', 'line', 'line', 'line', 'line', 'points', 'points'])
    DataViz.plot_dataset(dataset[dataset['labelRunning']== 1], ['acc_'],
                                  ['like', 'like', 'like', 'like', 'like', 'like', 'like','like'],
                                  ['line', 'line', 'line', 'line', 'line', 'line', 'points', 'points'])
