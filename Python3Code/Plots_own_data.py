...
for milliseconds_per_instance in GRANULARITIES:
    ...
    dataset.add_numerical_dataset('Lopen/Accelerometer_timestamps.csv', 'Time (s)', ['X (m/s^2)','Y (m/s^2)','Z (m/s^2)'], 'avg', 'acc_phone_')
    print(dataset)
...
#         print(dataset)
#         # dataset['X (m/s^2)'] = dataset['X (m/s^2)'].astype(int)
#         # dataset['Y (m/s^2)'] = dataset['Y (m/s^2)'].astype(int)
#         # dataset['Z (m/s^2)'] = dataset['Z (m/s^2)'].astype(int)
